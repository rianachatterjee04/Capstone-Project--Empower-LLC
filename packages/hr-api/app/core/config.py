...
class Settings(BaseSettings):
    ...
    # SECURITY: default to production. _is_prod() in app/api/deps.py keys the
    # unsigned dev: auth bypass off this value, and render.yaml does not set ENV,
    # so a "dev" default silently left that bypass ENABLED in production.
    # Local development sets ENV=development via .env (see .env.example).
    ...
    internal_ai_shared_secret: str | None = Field(default=None, alias="INTERNAL_AI_SHARED_SECRET")
