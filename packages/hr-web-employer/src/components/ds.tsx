 ...
 * Loading placeholder.
 *
 * This lived in `equity-ui.tsx`, so removing the cap-table feature from a build
 * also removed the loading state used by the audit log -- a page with nothing to
 * do with equity, which then failed to compile. A generic primitive belongs in
 * the design system, where no feature removal can take it away.
 */
